		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CCN Accept",
									"targetURL": "#ccnacceptworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ccnacceptworkflowuimodule-display": {
								"semanticObject": "ccnacceptworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ccnaccept.workflowuimodule",
									"url": sap.ui.require.toUrl("ccnaccept/workflowuimodule")
								}
							}
						}
					}
